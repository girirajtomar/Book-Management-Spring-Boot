...
public class RestClient {
	...
	private static final String GET_ALL_BOOK_API = "http://localhost:8080/getallbooks";
	private static final String GET_BOOK_BY_ID_API = "http://localhost:8080/getbook/{id}";
	private static final String ADD_BOOK_API = "http://localhost:8080/addbook";
	private static final String UPDATE_BOOK_API = "http://localhost:8080/updatebook";
	private static final String DELETE_BOOK_API = "http://localhost:8080/deletebook/{id}";
	private static final String GET_ALL_AUTHORS = "http://localhost:8080/getallauthors";
